...
Frame.prototype.receiveShot = function(hitpins) {
  if (this.isFrame10) { this.receiveShotFrame10(hitpins);
  } else { this.receiveShotRegularFrame(hitpins);
  };
};

Frame.prototype.receiveShotRegularFrame = function(hitpins) {
...
Frame.prototype.receiveShotFrame10 = function(hitpins) {
  ...
  this.shotCount++;
    ...
    Frame.prototype._checkShotLegalityFrame10 = function(hitpins) {
      if (((this.isSpare() || this.isStrike()) && this.shotCount === 3) || ((!this.isStrike() && !this.isSpare()) && this.shotCount === 2)) { 
